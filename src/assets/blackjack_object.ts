...
class BlackJack {
	...
	constructor() {
		...
		this.new_deck = function () {
			let ordered_deck = []
			for (let i: number = 52; i > 0; i--) ordered_deck.push((i % 13) + 1)

			return ordered_deck
		}

		this.shuffle = function (deck: string[]) {
