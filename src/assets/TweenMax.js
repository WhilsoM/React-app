						...
						if (this._yoyo)
							if ((this._cycle & 1) !== 0) {
								...
								if (yoyoEase) {
											...
											this._yoyoEase = yoyoEase = !yoyoEase
												...
												: yoyoEase instanceof Ease
												  ...
												  : typeof yoyoEase === 'function'
												    ? new Ease(yoyoEase, this.vars.easeParams)
									...
									this.ratio = yoyoEase
										? 1 - yoyoEase.getRatio((duration - this._time) / duration)
										: 0
								}
							}
	...
	p.isActive = function () {
		...
		return (
			...
			(!this._gc &&
				...
				rawTime <
					startTime + this.totalDuration() / this._timeScale - 0.0000001)
		)
	}
		...
		_addPropTween = function (
			...
			if (typeof s !== 'number' || (typeof end !== 'number' && !isRelative)) {
				if (
					...
					blob = _blobDif(
						s,
						isRelative ? parseFloat(pt.s) + pt.c : end,
